...
$app_strings = array(
    ...
    'LBL_EMAIL_OPT_IN' => 'Opted In',
    'LBL_EMAIL_OPT_IN_AND_INVALID' => 'Opted In and Invalid',
    ...
    'LBL_COUNTRY' => 'País:',
    'LBL_CREATE_BUTTON_LABEL' => 'Nuevo', //Can be translated in all caps. This string will be used by SuiteP template menu actions
...
$app_list_strings['aor_format_options']['%b'] = 'Mes Corto';
$app_list_strings['aor_format_options']['%b, Y'] = 'Mes Corto, A';
$app_list_strings['aor_format_options']['Y, %b'] = 'A, Mes Corto';

$app_list_strings['aor_format_options']['i'] = 'Mes';
$app_list_strings['aor_format_options']['i, Y'] = 'Mes, A';
$app_list_strings['aor_format_options']['Y, i'] = 'A, Mes';

$app_list_strings['aor_format_options']['%r'] = 'hh:mm:ss AA';

$app_list_strings['aor_format_options']['%T'] = 'HH:MM:SS';

$app_list_strings['aor_format_options']['%V'] = 'Semana del Año D';

$app_list_strings['aor_format_options']['%v'] = 'Semana del Año L';

$app_list_strings['aor_format_options']['%j'] = 'Día del Año';

$app_list_strings['aor_format_options']['first_day_of_week'] = 'Semana Fecha';

$app_list_strings['aor_format_options']['number_of_week_day'] = 'Día de la Semana';

$app_list_strings['aor_format_options']['number_of_week_month'] = 'Semana del Mes';
...
// Future periods
//-----------------------------------------------------------------------------------------------------
$app_list_strings['date_time_period_list']['tomorrow'] = 'Mañana';
$app_list_strings['date_time_period_list']['next_week'] = 'Próxima Semana';
$app_list_strings['date_time_period_list']['next_month'] = 'Próximo Mes';
$app_list_strings['date_time_period_list']['next_quarter'] = 'Próximo Trimestre';
$app_list_strings['date_time_period_list']['next_year'] = 'Próximo Año';
//-----------------------------------------------------------------------------------------------------
...
$app_list_strings['aow_operator_list']['is_not_null'] = 'Es No Nulo';
