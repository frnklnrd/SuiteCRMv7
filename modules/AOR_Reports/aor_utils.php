...
function getPeriodDate($date_time_period_list_selected)
{
    ...
    //----------------------------------------------------------------------------------------------------
    // TPX CUSTOM CODE
    // Adicionar Periodos Futuros en las Condiciones de los reportes
    //----------------------------------------------------------------------------------------------------
    elseif ($date_time_period_list_selected == 'tomorrow') {
        $datetime_period = new DateTime('tomorrow');
    } elseif ($date_time_period_list_selected == 'next_week') {
        $datetime_period = new DateTime('next week');
    } elseif ($date_time_period_list_selected == 'next_month') {
        $datetime_period = new DateTime('first day of next month');
    } elseif ($date_time_period_list_selected == 'next_quarter') {
        $thisMonth = $datetime_period->setDate(
            $datetime_period->format('Y'),
            $datetime_period->format('m'),
            1
    ...
    } elseif ($date_time_period_list_selected == 'next_year') {
        $datetime_period = new DateTime('next year first day of january');
    }
    //---------------------------------------------------------------------------------------------------
...
function getPeriodEndDate($dateTimePeriodListSelected)
{
    switch ($dateTimePeriodListSelected) {
        //--------------------------------------------------------------------------------------------------------
        // TPX CUSTOM CODE
        // Sobrescribiendo fecha final de los periodos de las condiciones de los Reportes
        //--------------------------------------------------------------------------------------------------------
        case 'today':   //se mantiene igual
        ...
        //-----------------------------------------------------------------------------------------------------------------
        // TPX CUSTOM CODE
        // Definiendo Periodos Nuevos en los Reportes 
        //-----------------------------------------------------------------------------------------------------------------
        case 'tomorrow':
        ...
        case 'next_quarter':
            ...
            $thisMonth = $thisMonth->format('n');
            if ($thisMonth < 4) {
                $datetimePeriod = new DateTime('this year last day of june');
                $datetimePeriod->setTime(23, 59, 59);
            } elseif ($thisMonth > 3 && $thisMonth < 7) {
                $datetimePeriod = new DateTime('this year last day of september');
                $datetimePeriod->setTime(23, 59, 59);
            } elseif ($thisMonth > 6 && $thisMonth < 10) {
                $datetimePeriod = new DateTime('this year last day of december');
                $datetimePeriod->setTime(23, 59, 59);
            } elseif ($thisMonth > 9) {
                $datetimePeriod = new DateTime('next year last day of march');
                $datetimePeriod->setTime(23, 59, 59);
            }
            break;
        case 'next_year':
            $datetimePeriod = new DateTime("next year last day of december");
            $datetimePeriod->setTime(23, 59, 59);
            break;
        //------------------------------------------------------------------------------------
    }
