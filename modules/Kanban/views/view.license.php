...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
           ...
           translate('LBL_KANBANLICENSE','Administration').': '.translate('LBL_KANBANLICENSE_LICENSE_TITLE','Administration'),
           );
    }
    ...
    public function display()
    {
        ...
        if(isset($outfitters_config['manage_licensed_users']) && $outfitters_config['manage_licensed_users'] == true) {
            ...
            $last_validation = isset($administration->settings['SugarOutfitters_'.$outfitters_config['shortname']]) ? $administration->settings['SugarOutfitters_'.$outfitters_config['shortname']] : null;
            ...
            if(!empty($trimmed_last))
            {
                ...
                if(!empty($validated['result']) && is_array($validated['result']))
                {
