...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view">
    ...
    <tr>
        ...
        <td width="30%" colspan="3" scope="row">
            ...
            <span id="outfitters_validating_license" style="display: none"><img src="themes/default/images/img_loading.gif" alt="Loading"></img> {$LICENSE.LBL_SAVE_BUTTON_VALIDATIND_LABEL}</span>
            <span id="outfitters_validation_fail" style="display: none"><img src="themes/default/images/no.gif" alt="Failed"></img> {$LICENSE.LBL_SAVE_BUTTON_FAIL_LABEL}: <span id="outfitters_fail_message"></span></span>
            <span id="outfitters_validation_success" style="display: none">
                <img src="themes/default/images/yes.gif" alt="Success"></img> {$LICENSE.LBL_SAVE_BUTTON_SUCCESS_LABEL}!
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view">
            ...
            <tr>
                ...
                <td width="30%" scope="row" colspan="3">
                    ...
                    <span id="outfitters_increasing_license" style="display: none"><img src="themes/default/images/img_loading.gif" alt="Loading"></img> {$LICENSE.LBL_BOOSTING_IN_PROGRESS_LABEL}</span>
                    <span id="outfitters_license_increase" style="display: none">
                        <img src="themes/default/images/no.gif" alt="Warning"></img> {$LICENSE.LBL_BOOSTING_REQUIRED_LABEL}
                        <br/>
                        <button id="btn-outfitters-increase" onclick="javascript:outfitters_increase_license({$current_users}); return false;">{$LICENSE.LBL_BOOSTING_READY_LABEL}</button>
                    </span>
                    <span id="outfitters_license_passed" style="display: none">
                        <img src="themes/default/images/yes.gif" alt="Passed"></img> {$LICENSE.LBL_SAVE_BUTTON_SUCCESS_LABEL}!
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view manage-users" {if $validation_required == true}style="display: none"{/if}>
                ...
                <tr id="outfitters_show_additional_licenses">
                    ...
                    <td scope="row" colspan="3">
                        ...
                        <span id="outfitters_increasing_license" style="display: none"><img src="themes/default/images/img_loading.gif" alt="Loading"></img> {$LICENSE.LBL_SAVE_BUTTON_INCREASING_LABEL}</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td scope="row" colspan="3">
                        ...
                        <span id="outfitters_save_licensed_users" style="display: none"><img src="themes/default/images/img_loading.gif" alt="Loading"></img> {$LICENSE.LBL_SAVE_BUTTON_SAVING_USERS_LABEL}</span>
                        <span id="outfitters_save_licensed_users_fail" style="display: none"><img src="themes/default/images/no.gif" alt="Failed"></img> {$LICENSE.LBL_SAVE_BUTTON_FAIL_LABEL}: <span id="outfitters_save_licensed_users_fail_message"></span></span>
                        <span id="outfitters_save_licensed_users_success" style="display: none">
                            <span class="outfitters-success"><img src="themes/default/images/yes.gif" alt="Success"></img> {$LICENSE.LBL_SAVE_BUTTON_SUCCESS_LABEL}!</span>
                            {if !empty($continue_url)}
